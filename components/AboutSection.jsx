...
const aboutVideo = '/assets/videos/BGRemove.mp4';
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            <video
              ...
              className="w-3/4 md:max-w-2xl h-auto rounded-lg shadow-2xl drop-shadow-[0_0_15px_rgba(251,146,60,0.5)] object-cover object-[60%_40%]"
              autoPlay
              loop
              muted
              playsInline
