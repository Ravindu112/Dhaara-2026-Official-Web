...
const Tickets = () => {
  ...
  const ticketData = [
    { label: "Early bird", price: "1500", percentage: 95, status: "Available" },
    { label: "Standard", price: "2000", percentage: 10, status: "Available" },
    { label: "VIP", price: "3000", percentage: 5, status: "Available" },
